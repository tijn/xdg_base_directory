...
module XdgBaseDirectory
  ...
  # settings = xdg_dirs.config_home.read_file("settings.ini")
  # # ...
  # ```
  class XdgDirs
    # define a method to return the specified `XdgDir` for this application.
    macro def_xdg_dir(name)
      def {{name}}
    ...
    # This class assumes that all files live in a subdirectories of the XDG base dirs.
